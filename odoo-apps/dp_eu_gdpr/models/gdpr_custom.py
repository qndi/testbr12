...
class GDPR(models.TransientModel):
    ...
    object = fields.Reference([], 'Data Set')
    ...
    def _onchange_operation(self):
        if self.operation == 'access':
            self.help = _('A compressed ZIP file will be created, which provides the data in an CSV file.')
    ...
    def _prepare_log(self):
        ...
        objects = dict(self._fields['object'].selection)
        return {
